 ...
 */
    ...
    private void initComponents() {
        ...
        Ltestnom.setText("Nom administrateur");
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/image/Test-admin.jpg"))); // NOI18N
    ...
    private void BtestconfirmerActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtestconfirmerActionPerformed
      ...
      //  JOptionPane.showMessageDialog(this, " reussi le test ");
           ...
           try{
            ...
            if(d.AfficherPersonneTest("administrateur", nom, code)){
                this.setVisible(false);
               // JOptionPane.showMessageDialog(this, " reussi le test ");
                Accueil_Admin add=new Accueil_Admin();
                add.setVisible(true);
        ...
        }//JOptionPane.showMessageDialog(this, "mande ka");
             
    /*    String nom=Ttestnomadmin.getText();
            String code=Ttestpasse.getText();
           try{
            if(nom.equals("") || code.equals("")){
              //  ErreurTexte.setText (" Completez les zones de saisie ");
                JOptionPane.showMessageDialog(this, "mande ka");
            }else{
            if(d.AfficherPersonneTest("administrateur", nom, code)){
                JOptionPane.showMessageDialog(this, " reussi le test ");   
            }else{
                JOptionPane.showMessageDialog(this, " le test a echouer ");   
            }                
        }
        }catch(Exception ee){
